...
import NavMenuList from "@dt/NavMenuList/NavMenuList";
...
const MobileMenu: React.FC<MobileMenuProps> = ({
  ...
  React.useEffect(() => {
    console.log("MobileMenu mounted, showToast:", showToast);
  }, [showToast]);
  ...
  const handleLanguageChange = React.useCallback(
    (code: string) => {
      console.log("MobileMenu handleLanguageChange called with:", code);
    ...
    [i18n, onNavigate, languages, showToast, t],
  );

  const handleThemeToggle = React.useCallback(() => {
    console.log("MobileMenu handleThemeToggle called");
    console.log("showToast function:", showToast);
    ...
    const label = themeLabels[nextTheme] ?? nextTheme;
    try {
      showToast?.(t("themeChanged", { theme: label }), 3000);
    } catch (error) {
      console.error("Toast error:", error);
    }
  }, [cycleTheme, showToast, t]);
