...
const Header: React.FC<HeaderProps> = ({
  ...
  React.useEffect(() => {
    console.log("Header mounted, showToast:", showToast);
  }, [showToast]);
  ...
  const changeLanguage = React.useCallback(
    ...
    [i18n, onLanguageChange, languages, showToast, t],
  );
  ...
  }, [isThemeAnimating, cycleTheme, onThemeCycle, themeNames, showToast, t]);
