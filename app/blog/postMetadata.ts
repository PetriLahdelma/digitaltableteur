...
export const posts: BlogPostMeta[] = [
  {
    ...
    excerpt:
      "Branding a design system transforms it from invisible infrastructure into a living language that communicates values, builds trust, and makes every interaction feel intentional, human, and unmistakably coherent.",
    readTime: "3 min read",
  ...
  },
  {
    ...
    excerpt:
      "Part 2 of a 5-part series exploring how design systems transform in the age of AI.",
    readTime: "4 min read",
  ...
  },
  {
    ...
    excerpt:
      "Part 1 of a 5-part series exploring how design systems transform in the age of AI.",
    readTime: "4 min read",
