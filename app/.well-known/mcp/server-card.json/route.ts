...
import { PUBLIC_VALIDATOR_TOOL_NAMES } from "@/nextjs-app/shared/lib/design-system-mcp/register-public-validator";
import {
...
export async function GET() {
  ...
  const serverCard = {
    ...
    tools: [...CONSULTING_TOOL_NAMES, ...DOCS_REGISTRY_TOOL_NAMES, ...PUBLIC_VALIDATOR_TOOL_NAMES],
    authentication: {
      required: false,
