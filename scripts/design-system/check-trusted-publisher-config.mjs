...
const REQUIRED_REPOSITORY_PATHS = [
  ...
  "nextjs-app/shared/components/Timestamp/Timestamp.module.css",
  "nextjs-app/shared/components/Timestamp/Timestamp.tsx",
  "nextjs-app/shared/components/Timestamp/index.ts",
  ...
  "packages/web-components/src/generated/element-contracts.ts",
  "packages/web-components/src/generated/react-adapters.ts",
  "packages/web-components/src/index.ts",
  "packages/web-components/src/native.ts",
  "packages/web-components/src/native/base.ts",
  "packages/web-components/src/native/progress.ts",
  "packages/web-components/src/native/spinner.ts",
  "packages/web-components/src/react.ts",
  "packages/web-components/src/register-native.ts",
  "packages/web-components/src/register-react.ts",
  "packages/web-components/src/register.ts",
  "packages/web-components/src/registry.ts",
  "packages/web-components/tsconfig.types.json",
  "packages/web-components/vite.config.ts",
  "packages/web-components/web-components.config.mjs",
  ...
  "scripts/design-system/check-web-components.mjs",
  "scripts/design-system/generate-web-components.mjs",
...
if (!existsSync(WORKFLOW)) {
  ...
  for (const required of [
    ...
    "NPM_CONFIG_USERCONFIG=\"$RUNNER_TEMP/npm-publish.npmrc\" node scripts/design-system/check-npm-oidc-publish-auth.mjs @digitaltableteur/web-components",
