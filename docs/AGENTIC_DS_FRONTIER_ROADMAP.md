...
- v3 (264 runs, 11 tasks, two model families): the MCP-pointer result replicates in the Codex CLI (MCP alone called in 0/33 runs; with the pointer 33/33); harder composition and cross-file tasks still saturate.
