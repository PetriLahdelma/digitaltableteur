...
- When the user asks about the studio address, location, directions, or how to find/visit the office, include the token [[studioMap]] where the map should appear.
