...
export const titleByComponentName: Record<string, string> = {
  ...
  CodeBlockWindow: "Content/CodeBlockWindow",
  ...
  ToastStack: "Feedback/ToastStack",
  Menu: "Actions/Menu",
  SplitButton: "Actions/SplitButton",
  Breadcrumb: "Navigation/Breadcrumb",
  CommandPalette: "Navigation/CommandPalette",
  DataTable: "Data display/DataTable",
  LanguageSwitcher: "Navigation/LanguageSwitcher",
  Link: "Navigation/Link",
  NavLink: "Navigation/NavLink",
  Pagination: "Navigation/Pagination",
  TreeView: "Navigation/TreeView",
  SkipLink: "Navigation/SkipLink",
  Tabs: "Navigation/Tabs",
  SegmentedControl: "Navigation/SegmentedControl",
  Label: "Forms/Label",
  ...
  MultiCombobox: "Forms/MultiCombobox",
  FileUpload: "Forms/FileUpload",
  GroupLabel: "Forms/GroupLabel",
  PhoneInput: "Forms/PhoneInput",
  Select: "Forms/Select",
  ...
  Grid: "Layout/Grid",
  SelectableCard: "Layout/SelectableCard",
  SelectableCardGroup: "Layout/SelectableCardGroup",
  MacWindowFrame: "Layout/MacWindowFrame",
  ResizablePanelGroup: "Layout/ResizablePanelGroup",
  AspectRatio: "Layout/AspectRatio",
  Section: "Layout/Section",
  Spacer: "Layout/Spacer",
  Stack: "Layout/Stack",
  Accordion: "Layout/Accordion",
  ExpandableSection: "Layout/ExpandableSection",
  CookieConsent: "Site/CookieConsent",
  CategoryFilter: "Site/CategoryFilter",
  Gallery: "Site/Gallery",
  ReadingProgress: "Site/ReadingProgress",
  ValueCard: "Site/ValueCard",
  NavMenuList: "Site/NavMenuList",
  VisuallyHidden: "Site/VisuallyHidden",
  VirtualList: "Data display/VirtualList",
  Logo: "Site/Logo",
