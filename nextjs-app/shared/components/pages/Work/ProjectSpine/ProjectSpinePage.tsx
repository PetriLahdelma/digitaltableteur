  ...
  return (
    ...
    >
      ...
      <StoryBlock
        ...
        content={[
          <Text key="1" size="S">
            <span style={{ fontWeight: 600 }}>brief.md</span>. A client or
          ...
          <Text key="2" size="S">
            <span style={{ fontWeight: 600 }}>Repo directory</span>. Scanned for{" "}
            <code>package.json</code>, <code>tsconfig.json</code>, and framework
            signals. Spine doesn&apos;t need you to describe your stack; it
            reads it.
          </Text>,
          <Text key="3" size="S">
            <span style={{ fontWeight: 600 }}>tokens.json</span> (optional).
      ...
      <StoryBlock
        ...
        content={[
          <Text key="1" size="S">
            <span style={{ fontWeight: 600 }}>AGENTS.md generators</span> dump
            boilerplate. Spine reads the actual brief + repo + tokens and
            produces repo-specific content.{" "}
            <span style={{ fontWeight: 600 }}>Design token transformers</span>{" "}
