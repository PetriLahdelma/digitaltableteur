...
## Intent
Documents how **AdaptiveLoadingButton** is used in production layouts and Storybook examples.
...
## Do / don't
- Do: Match the **Example** story composition on AdaptiveLoadingButton pages.
