...
export type CookieCategory =
  ...
  | "marketing" // Marketing cookies, ads (currently none)
  | "functional"; // Chat widget, preferences
...
export interface CategoryConsent {
  ...
  consented: boolean;
  required: boolean; // Essential cookies can't be disabled
}
...
export interface ConsentState {
  ...
  language: string; // Language when consent given
